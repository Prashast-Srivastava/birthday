        ...
        {filteredMemories.map((mem, index) => {
          ...
          return (
            ...
            >
              ...
              <div className="relative w-full aspect-[3/4] bg-pink-50/50 rounded-2xl overflow-hidden flex items-center justify-center border border-white/80 shadow-inner">
        ...
        >
          ...
          >
            ...
            <div className="p-5 sm:p-6 overflow-y-auto space-y-4">
              {/* 4:3 Image Viewport */}
              <div className="relative w-full aspect-[3/4] bg-pink-50 rounded-2xl border border-white/80 overflow-hidden flex items-center justify-center shadow-inner">
